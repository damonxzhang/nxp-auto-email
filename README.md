...
### 2026-06-17
- **新增“异常物料处理系统”**: 全面承接异常物料检查、工程师处置意见反馈、带班按需处理、多级奖励审批、奖励申诉等核心全流程环节。
- **待办多段流程可视化**: 升级任务数据大屏，直接在主表中集成横向链条式“节点轨迹进度图”（Completed -> Current -> Upcoming），实时、一目了然看清任务当前走到了哪一步、后续哪几个关键环节。
